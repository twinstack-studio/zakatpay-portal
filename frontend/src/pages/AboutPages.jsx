...
import { 
  ...
  BookText, Mail, HelpCircle, ChevronDown, Check 
} from 'lucide-react';
import { auditReports, ebooks } from '../data/library';
import { buildAuditReport, buildEbook } from '../utils/documents';
  ...
  return (
    <div className="w-full pb-24 framer-animate">
      <div className="bg-white/5 border-b border-white/10 py-16 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4">Discover <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-500">ZakatPay</span></h1>
        <p className="text-slate-400 text-sm sm:text-base md:text-lg max-w-2xl mx-auto">Bridging the gap between faithful donors and verified charitable causes through modern technology.</p>
      </div>
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 mt-10 sm:mt-16 space-y-14 sm:space-y-20 md:space-y-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-white mb-4 sm:mb-6 border-l-4 border-pink-500 pl-4">Who We Are</h2>
            <p className="text-slate-400 text-sm sm:text-base md:text-lg leading-relaxed mb-4 sm:mb-6">ZakatPay is Pakistan's premier digital philanthropy gateway. Founded with the intention to digitize and secure Islamic charitable giving, we provide a unified platform where Muslims can calculate their exact religious dues and transfer them directly to FBR-certified organizations.</p>
            <p className="text-slate-400 text-sm sm:text-base md:text-lg leading-relaxed">We do not charge any platform fees. 100% of your donated amount reaches the beneficiary, ensuring complete transparency and spiritual peace of mind.</p>
          </div>
          <div className="rounded-3xl overflow-hidden shadow-[0_0_30px_rgba(236,72,153,0.2)] border border-white/10">
            <img src="https://images.unsplash.com/photo-1542816417-0983c9c9ad53?auto=format&fit=crop&w=800&q=80" alt="Islamic Architecture" className="w-full h-[220px] sm:h-[320px] md:h-[400px] object-cover" />
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8">
          <div className="bg-gradient-to-br from-pink-900/20 to-black border border-pink-500/30 p-5 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl relative overflow-hidden">
            <Eye size={64} className="text-pink-500/20 absolute -bottom-4 -right-4" />
            <div className="w-14 h-14 bg-pink-500/20 rounded-2xl flex items-center justify-center text-pink-400 mb-4 sm:mb-6"><Eye size={28} /></div>
          ...
          <div className="bg-gradient-to-br from-purple-900/20 to-black border border-purple-500/30 p-5 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl relative overflow-hidden">
            <Target size={64} className="text-purple-500/20 absolute -bottom-4 -right-4" />
            <div className="w-14 h-14 bg-purple-500/20 rounded-2xl flex items-center justify-center text-purple-400 mb-4 sm:mb-6"><Target size={28} /></div>
        ...
        <div>
          <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-center text-white mb-8 sm:mb-10 md:mb-12">Our Core Impact Areas</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="relative h-[200px] sm:h-[260px] md:h-[300px] rounded-2xl sm:rounded-3xl overflow-hidden group">
        ...
        <div>
          <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-center text-white mb-8 sm:mb-10 md:mb-12">Platform Services</h2>
        ...
        <div className="relative rounded-3xl overflow-hidden mt-16 group shadow-2xl">
          ...
          <div className="relative z-20 text-center py-20 px-6">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-4 sm:mb-6">Join Our Mission</h2>
            <p className="text-pink-100 text-lg max-w-2xl mx-auto mb-6 sm:mb-8 md:mb-10 leading-relaxed">Every contribution, no matter how small, creates ripples of positive change. Together, we can build a nation where compassion knows no bounds and poverty is eradicated through the power of Zakat.</p>
            <Link to="/foundations" className="inline-flex items-center gap-2 bg-white text-purple-700 hover:text-pink-600 px-8 py-4 rounded-full font-bold text-lg transition-colors shadow-xl mb-8 sm:mb-10 md:mb-12 hover:scale-105"><Heart size={20} className="fill-current" /> Donate Now</Link>
            <div className="pt-8 border-t border-white/20 max-w-md mx-auto">
              <p className="text-white/80 text-xs font-bold uppercase tracking-widest mb-4 sm:mb-6">Follow Our Journey of Compassion</p>
...
export function ChairmansMessagePage() {
  return (
    <div className="w-full pb-24 framer-animate">
      <div className="bg-white/5 border-b border-white/10 py-16 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4">Chairman's <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-500">Message</span></h1>
      </div>
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6 mt-10 sm:mt-16">
        <div className="bg-[#0a0a0c] border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row gap-5 sm:gap-8 lg:gap-10 items-center md:items-start relative z-10">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2">A Journey of Trust</h2>
              <p className="text-pink-400 font-bold text-sm uppercase tracking-widest mb-4 sm:mb-6">Wasil Nadeem - Founder & Chairman, ZakatPay</p>
...
export function PrivacyPolicyPage() {
  return (
    <div className="w-full pb-24 framer-animate">
      <div className="bg-white/5 border-b border-white/10 py-16 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4">Privacy <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-500">Policy</span></h1>
      ...
      <div className="max-w-[900px] mx-auto px-4 sm:px-6 mt-10 sm:mt-16 bg-[#0a0a0c] border border-white/10 p-5 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl text-slate-300 space-y-8 leading-relaxed shadow-xl">
        <div>
...
export function TermsConditionsPage() {
  return (
    <div className="w-full pb-24 framer-animate">
      <div className="bg-white/5 border-b border-white/10 py-16 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4">Terms & <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-500">Conditions</span></h1>
...
export function TaxExemptionPage() {
  return (
    <div className="w-full pb-24 framer-animate">
      <div className="bg-white/5 border-b border-white/10 py-16 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4">Tax <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-500">Exemption</span></h1>
        <p className="text-slate-400 text-sm sm:text-base md:text-lg max-w-2xl mx-auto">Learn how your donations on ZakatPay can reduce your annual income tax liability.</p>
      </div>
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 mt-10 sm:mt-16 space-y-12">
        <div className="bg-gradient-to-br from-purple-900/20 to-black border border-purple-500/30 p-5 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl text-center">
...
export function EBookPage() {
  ...
  const handleDownload = (book) => {
    setBusy(book.id);
    try {
      downloadPdf(buildEbook(book), `ZakatPay_${book.title.replace(/[^A-Za-z0-9]+/g, '_')}.pdf`);
    } finally {
  ...
  return (
    <div className="w-full pb-16 sm:pb-24 framer-animate">
      <div className="bg-white/5 border-b border-white/10 py-12 sm:py-16 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4">Digital <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-500">E-Books</span></h1>
        <p className="text-slate-400 text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4">Enhance your Islamic knowledge with our free downloadable resources.</p>
      </div>

      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 mt-10 sm:mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8">
        {ebooks.map((book) => (
          <div key={book.id} className="bg-[#0a0a0c] border border-white/10 rounded-2xl sm:rounded-3xl p-5 sm:p-6 group hover:border-pink-500/50 transition-all flex flex-col">
            <div className={`w-full h-56 sm:h-64 bg-gradient-to-br ${book.color} rounded-xl sm:rounded-2xl mb-4 sm:mb-6 flex flex-col justify-between text-left p-5 shadow-lg group-hover:scale-[1.03] transition-transform`}>
              <div className="flex items-center justify-between">
                <BookText size={30} className="text-white/60" />
                <span className="text-[9px] font-bold text-white/70 uppercase tracking-widest">{book.chapters.length} chapters</span>
              </div>
              <div>
                <h3 className="text-lg sm:text-xl md:text-2xl font-black text-white leading-tight">{book.title}</h3>
                <div className="w-10 h-[3px] bg-white/70 my-3"></div>
                <p className="text-white/80 text-[11px] leading-snug">{book.subtitle}</p>
              </div>
            </div>

            <p className="text-slate-400 text-sm mb-4 flex-grow">{book.desc}</p>
            <p className="text-slate-600 text-[10px] font-bold uppercase tracking-widest mb-4">{book.edition}</p>

            <button
              onClick={() => handleDownload(book)}
              disabled={busy === book.id}
              className="w-full h-12 bg-white/5 hover:bg-pink-600 text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2 disabled:opacity-60"
            >
              {busy === book.id
...
export function NewsletterArchivePage() {
  ...
  return (
    <div className="w-full pb-24 framer-animate">
      <div className="bg-white/5 border-b border-white/10 py-16 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4">Newsletter <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-500">Archive</span></h1>
      </div>
      <div className="max-w-[800px] mx-auto px-4 sm:px-6 mt-10 sm:mt-16">
...
export function AuditReportsPage() {
  ...
  const handleDownload = (e, report) => {
    ...
    setBusy(report.id);
    try {
      downloadPdf(buildAuditReport(report), `ZakatPay_Audit_${report.year.replace(/\s*-\s*/, '-')}_${report.ref.split('/').pop()}.pdf`);
    } finally {
      setTimeout(() => setBusy(null), 900);
    }
  };
  ...
  return (
    <div className="w-full pb-24 framer-animate">
      <div className="bg-white/5 border-b border-white/10 py-12 sm:py-16 md:py-20 text-center relative overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[min(800px,120vw)] h-[min(800px,120vw)] bg-purple-600/10 rounded-full blur-[70px] sm:blur-[120px] pointer-events-none"></div>
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4 sm:mb-6 relative z-10">
          Financial <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-500">Transparency</span>
        </h1>
        <p className="text-slate-400 text-sm sm:text-base md:text-lg max-w-3xl mx-auto relative z-10">
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 mt-10 sm:mt-16 space-y-10 sm:space-y-14 md:space-y-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-white/5 to-transparent p-5 sm:p-8 rounded-2xl sm:rounded-3xl border border-white/10 hover:border-pink-500/50 transition-colors">
            <div className="w-14 h-14 bg-pink-500/20 rounded-2xl flex items-center justify-center text-pink-400 mb-4 sm:mb-6"><PieChart size={28} /></div>
          ...
          <div className="bg-gradient-to-br from-white/5 to-transparent p-5 sm:p-8 rounded-2xl sm:rounded-3xl border border-white/10 hover:border-purple-500/50 transition-colors">
            <div className="w-14 h-14 bg-purple-500/20 rounded-2xl flex items-center justify-center text-purple-400 mb-4 sm:mb-6"><ShieldCheck size={28} /></div>
          ...
          <div className="bg-gradient-to-br from-white/5 to-transparent p-5 sm:p-8 rounded-2xl sm:rounded-3xl border border-white/10 hover:border-pink-500/50 transition-colors">
            <div className="w-14 h-14 bg-pink-500/20 rounded-2xl flex items-center justify-center text-pink-400 mb-4 sm:mb-6"><BookOpen size={28} /></div>
        ...
        <div className="bg-[#0a0a0c] border border-white/10 rounded-3xl p-10 shadow-2xl">
          <h2 className="text-lg sm:text-xl md:text-2xl font-black text-white mb-5 sm:mb-8 text-center">Where Your Zakat Goes</h2>
        ...
        <div>
          <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-white mb-5 sm:mb-8">Download Annual Reports</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {auditReports.map((report) => (
              <div key={report.id} className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-white/10 transition-colors group">
                <div className="flex items-start sm:items-center gap-4 min-w-0">
                  <div
                    className="w-11 h-11 sm:w-12 sm:h-12 shrink-0 rounded-xl flex items-center justify-center"
                    style={{ backgroundColor: `rgba(${report.accent.join(',')},0.18)`, color: `rgb(${report.accent.join(',')})` }}
                  >
                    <FileText size={22} />
                  </div>
                  <div className="min-w-0">
                    ...
                    <div className="flex flex-wrap gap-x-3 gap-y-1 mt-2 text-[10px] font-bold text-slate-500 uppercase tracking-widest">
                      <span>{report.date}</span><span className="hidden sm:inline">&bull;</span>
                      <span>PDF ({report.size})</span><span className="hidden sm:inline">&bull;</span>
                ...
                <button
                  ...
                  className="h-10 shrink-0 px-4 rounded-full bg-white/5 border border-white/10 flex items-center justify-center gap-2 text-xs font-bold text-slate-200 hover:bg-pink-500 hover:border-pink-500 hover:text-white transition-all disabled:opacity-60"
                >
                  {busy === report.id
...
export function FAQPage() {
  ...
  return (
    <div className="w-full pb-24 framer-animate">
      <div className="bg-white/5 border-b border-white/10 py-16 text-center">
        <div className="w-16 h-16 bg-pink-500/20 text-pink-400 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6"><HelpCircle size={32} /></div>
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4">Frequently Asked <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-500">Questions</span></h1>
        <p className="text-slate-400 text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4">Everything you need to know about ZakatPay, secure payments, and Islamic rulings.</p>
      </div>
...
export function PlaceholderPage({ title, desc }) {
  return (
    <div className="w-full py-16 sm:py-24 md:py-32 text-center framer-animate">
      <div className="inline-block p-6 rounded-full bg-white/5 border border-white/10 mb-4 sm:mb-6">
        <Activity size={48} className="text-pink-500 animate-pulse" />
      </div>
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4">{title}</h1>
