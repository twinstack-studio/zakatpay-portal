/**
 * Partner foundations shown on the Foundations, detail, donate and checkout pages.
 * Kept out of the page component so other pages can import it without breaking
 * React Fast Refresh.
 */
