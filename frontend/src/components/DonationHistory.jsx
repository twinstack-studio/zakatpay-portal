...
export default function DonationHistory({ user }) {
  ...
  return (
    <div className="framer-animate max-w-5xl mx-auto">
      <div className="text-center mb-12">
        <h2 className="text-4xl font-black text-white mb-4 tracking-tight">Tax Receipts & History</h2>
        <p className="text-slate-400">Track your spiritual portfolio and generate FBR-compliant receipts.</p>
      </div>
