...
export default function CharityDetail() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pb-12">
      <Link to="/charities" className="inline-flex items-center gap-2 text-slate-400 hover:text-pink-400 transition-colors mb-6 font-medium">
        <ArrowLeft size={18} /> Back to Organizations
      </Link>

      <div className="relative w-full h-[300px] md:h-[400px] rounded-3xl overflow-hidden mb-12 shadow-[0_0_40px_rgba(236,72,153,0.15)] group">
        ...
        <div className="absolute bottom-0 left-0 p-8 md:p-12 z-20">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white tracking-tight mb-2">{charity.name}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
            ...
            <p className="text-slate-400 text-lg leading-relaxed">{charity.about}</p>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
            <h3 className="text-xl font-bold text-white mb-6 border-b border-white/10 pb-4">Reach Out Directly</h3>
